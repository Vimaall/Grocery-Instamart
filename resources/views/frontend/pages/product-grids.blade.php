...
@section('title','GroceryInstamart || PRODUCT PAGE')
                                    ...
                                    <div class="shop-shorter">
                                        <div class="single-shorter">
                                            ...
                                            <select class="show" name="show" onchange="this.form.submit();">
                                                ...
                                                <option value="9" @if(!empty($_GET['show']) && $_GET['show']=='9') selected @endif>05</option>
                                                <option value="15" @if(!empty($_GET['show']) && $_GET['show']=='15') selected @endif>10</option>
                                                <option value="21" @if(!empty($_GET['show']) && $_GET['show']=='21') selected @endif>15</option>
